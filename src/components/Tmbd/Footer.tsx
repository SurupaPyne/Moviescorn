                ...
                <div className="container">
                    <div className="row text-center text-xs-center text-sm-left text-md-left">
                        <div className="col-xs-12 col-sm-4 col-md-4">
                            ...
                            <ul className="list-unstyled quick-links">
                                ...
                                <li><a href="/movies"><i className="fa fa-angle-double-right"></i>Movies</a></li>
                                <li><a href="/series"><i className="fa fa-angle-double-right"></i>TV Series</a></li>
                    ...
                    <div className="row">
                        <div className="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                            <p className="h6">© All right Reversed.<a className="text-green ml-2" href="https://www.sunlimetech.com" target="_blank">Moviescron</a></p>
                        </div>
                        <hr />
                    </div>
                </div>
